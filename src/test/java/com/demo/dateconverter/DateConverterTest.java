...
public class DateConverterTest {
    ...
    @Test
    public void testBsToAd() throws CustomerYetToBornException {
    ...
    public void incorrectDateFormat() throws CustomerYetToBornException {
        dc.convertBsToAd("290320104");
    }

    @Test(expected = CustomerDiedException.class)
    public void testCustomerDied() throws CustomerYetToBornException {
        dc.convertBsToAd("29031000");
    }

    @Test(expected = CustomerYetToBornException.class)
    public void testCustomerYetoBorn() throws CustomerYetToBornException {
